...
final class VerisignBindAllProfileResourceRecordSetApi implements AllProfileResourceRecordSetApi {

  private final VerisignBind api;
  private final String zoneName;

  VerisignBindAllProfileResourceRecordSetApi(VerisignBind api, String zoneName) {
    this.api = api;
  ...
  public void put(ResourceRecordSet<?> rrset) {
    ...
    api.updateResourceRecord(zoneName, rrset.name(), rrset.ttl());
  }
  ...
  static final class Factory implements denominator.AllProfileResourceRecordSetApi.Factory {
    ...
    @Override
    public VerisignBindAllProfileResourceRecordSetApi create(String name) {
      return new VerisignBindAllProfileResourceRecordSetApi(api, name);
    }
  }
}
